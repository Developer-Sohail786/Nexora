...
export default function RecentUsage({activities}: Props) {
  return (
    <section className="rounded-2xl border border-white/10 bg-[#1C1926] p-6">
      ...
      <div className="space-y-5">
        {activities.map((activity) => {
          const Icon = activity.type==="chat"? MessageSquare: activity.type==="file"? FileText: ImageIcon;
  ...
  : "Generated an image"}
              ...
              <span className="text-xs text-[#5C5870]">{formatDistanceToNow(
