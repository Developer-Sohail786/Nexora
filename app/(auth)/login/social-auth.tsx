...
}) } className="w-full flex items-center justify-center gap-2 rounded-lg border border-white/[0.07] bg-transparent py-2.5 text-sm font-medium text-white hover:bg-white/5 transition-colors">
        <FcGoogle />
